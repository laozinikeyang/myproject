...
<script type="text/javascript">
    var setting = {
			async: {
				enable: true,
				url:"<%=basePath%>per/getTree.spring"
			},data: {
				simpleData: {
					enable:true,
					idKey: "id",
			...
			callback: {
				beforeClick: function(treeId, treeNode) {
					...
					$("#testIframe").attr("src","<%=basePath%>per/editView.spring?permissionId="+treeNode.id+"&permissionMenuPid="+treeNode.pId+"&permissionName="+treeNode.type+"&permissionMenuName="+treeNode.name);
					return true;
				},
